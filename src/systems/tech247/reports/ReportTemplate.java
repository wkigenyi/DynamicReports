...
package systems.tech247.reports;
...
public class ReportTemplate {
	...
	static {
		...
		dynamicReportsComponent = cmp.horizontalList(cmp.image(ReportTemplate.class.getResource("images/dynamicreports.png")).setFixedDimension(60, 60),
				cmp.verticalList(
